...
_DP_CRUISE_MIN_V =       [-0.75,  -0.75,  -0.70, -0.70,  -0.70, -0.55]
_DP_CRUISE_MIN_V_ECO =   [-0.75,  -0.70,  -0.60, -0.60,  -0.55, -0.45]
...
_DP_CRUISE_MAX_V_ECO =   [2.5, 2.0, 1.7, 1.3, 0.9, 0.68, 0.54, 0.36, 0.28, 0.09]
